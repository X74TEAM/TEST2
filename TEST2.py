...
def DEVHIS2(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; Samsung Build/QQ2A.410478.054; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/110.0.5986.313 Mobile Safari/537.36',}
