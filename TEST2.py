...
def DEVHIS2(uid,pwx,tl):
    ...
    'method': 'GET',
    'path':'https://mbasic.alpha.facebook.com',
    'scheme': 'https',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 13; SM-N980F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36',}
