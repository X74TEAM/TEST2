...
def DEVHIS2(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 14; Samsung Build/TQ2A.278498.095; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/117.0.6788.601 Mobile Safari/537.36',}
