...
def DEVHIS2(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; U; Android 9; fr-fr; SM-G950F Build/PPR1.180610.011) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.130 Mobile Safari/537.36 PHX/13.1',}
